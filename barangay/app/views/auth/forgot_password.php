                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <?php flash_alert(); ?>
                                    <form role="form" method="post" action="<?= site_url('forgot_password'); ?>">
                                        <div class="text-center mb-3" style="font-size: 12px">
                                            Input your valid and registered email.
                                        </div>
                                        <div class="form-group mb-3">
                                            <div class="input-group input-group-merge input-group-alternative">
                                                ...
                                                <input class="form-control" id="email" placeholder="Enter your email" type="text" name="email" style="font-size: 13px;" required>
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" name="reset_password" class="btn btn-success my-4">Reset Password</button>
                                        </div>
                                    </form>
                                    <div class="text-center">
